...
classdef Constrained < gtsam.noiseModel.Diagonal
  ...
  methods
    function obj = Constrained(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(668, varargin{2});
        end
        base_ptr = gtsam_wrapper(667, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(669, obj.ptr_gtsamnoiseModelConstrained);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(672, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = MixedVariances(varargin)
      ...
      elseif length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(681, varargin{:});
      else
