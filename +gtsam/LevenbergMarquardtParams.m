  ...
  methods
    function obj = LevenbergMarquardtParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        ...
        base_ptr = gtsam_wrapper(1294, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1296);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1297, obj.ptr_gtsamLevenbergMarquardtParams);
    end
    ...
    function varargout = setlambdaUpperBound(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1324, this, varargin{:});
    end
