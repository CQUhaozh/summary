...
classdef PriorFactorConstantBias < gtsam.NoiseModelFactor
  ...
  methods
    function obj = PriorFactorConstantBias(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1745, varargin{2});
        end
        base_ptr = gtsam_wrapper(1744, my_ptr);
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.imuBias.ConstantBias') && isa(varargin{3},'gtsam.noiseModel.Base')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1746, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1747, obj.ptr_gtsamPriorFactorConstantBias);
    end
    ...
    function varargout = unwhitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(1761, this, varargin{:});
      else
    ...
    function varargout = whitenedError(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Values')
        varargout{1} = gtsam_wrapper(1762, this, varargin{:});
      else
    ...
    function varargout = string_serialize(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1763, this, varargin{:});
      else
