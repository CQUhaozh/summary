  ...
  methods
    function obj = SymbolicBayesTree(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(621, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(622);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesTree')
        my_ptr = gtsam_wrapper(623, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(624, obj.ptr_gtsamSymbolicBayesTree);
    end
    ...
    function varargout = deleteCachedShortcuts(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(626, this, varargin{:});
    end
