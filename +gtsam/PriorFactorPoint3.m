...
classdef PriorFactorPoint3 < gtsam.NoiseModelFactor
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(1579, obj.ptr_gtsamPriorFactorPoint3);
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1596, varargin{:});
      else
