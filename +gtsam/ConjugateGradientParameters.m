...
classdef ConjugateGradientParameters < gtsam.IterativeOptimizationParameters
  ...
  methods
    function obj = ConjugateGradientParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1019, varargin{2});
        end
        base_ptr = gtsam_wrapper(1018, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1020);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1021, obj.ptr_gtsamConjugateGradientParameters);
    end
    ...
    function varargout = setVerbosity(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1034, this, varargin{:});
      else
