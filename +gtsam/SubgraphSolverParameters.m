...
classdef SubgraphSolverParameters < gtsam.ConjugateGradientParameters
  ...
  methods
    function obj = SubgraphSolverParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1036, varargin{2});
        end
        base_ptr = gtsam_wrapper(1035, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1037);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1038, obj.ptr_gtsamSubgraphSolverParameters);
    end
    ...
    function varargout = setReset(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1050, this, varargin{:});
    end
