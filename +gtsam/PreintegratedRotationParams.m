...
classdef PreintegratedRotationParams < handle
  ...
  methods
    function obj = PreintegratedRotationParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2220, varargin{2});
        end
        gtsam_wrapper(2219, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2221);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2222, obj.ptr_gtsamPreintegratedRotationParams);
    end
    ...
    function varargout = getGyroscopeCovariance(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2224, this, varargin{:});
    end
    ...
    function varargout = setBodyPSensor(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Pose3')
        gtsam_wrapper(2226, this, varargin{:});
      else
    ...
    function varargout = setGyroscopeCovariance(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(2227, this, varargin{:});
      else
    ...
    function varargout = setOmegaCoriolis(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        gtsam_wrapper(2228, this, varargin{:});
      else
