  ...
  methods
    function obj = ISAM2Result(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1454, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1455);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1456, obj.ptr_gtsamISAM2Result);
    end
    ...
    function varargout = getCliques(this, varargin)
      ...
      varargout{1} = gtsam_wrapper(1457, this, varargin{:});
    end
    ...
    function varargout = getVariablesReeliminated(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1458, this, varargin{:});
    end
