  ...
  methods
    function obj = StereoCamera(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(527, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(528);
    ...
    function delete(obj)
      gtsam_wrapper(530, obj.ptr_gtsamStereoCamera);
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.StereoCamera') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(535, this, varargin{:});
      else
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(538, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(543, varargin{:});
      else
