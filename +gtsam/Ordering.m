  ...
  methods
    function obj = Ordering(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1083, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1084);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Ordering')
        my_ptr = gtsam_wrapper(1085, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1086, obj.ptr_gtsamOrdering);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1089, this, varargin{:});
      else
    ...
    function varargout = push_back(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1090, this, varargin{:});
    end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1092, this, varargin{:});
      else
