...
classdef SymbolicFactorGraph < handle
  ...
  methods
    function obj = SymbolicFactorGraph(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(561, varargin{2});
        end
        gtsam_wrapper(560, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(562);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesNet')
        my_ptr = gtsam_wrapper(563, varargin{1});
    ...
    function delete(obj)
      gtsam_wrapper(565, obj.ptr_gtsamSymbolicFactorGraph);
    end
    ...
    function varargout = eliminatePartialMultifrontal(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(568, this, varargin{:});
    ...
    function varargout = eliminatePartialSequential(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(570, this, varargin{:});
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.KeyVector')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(571, this, varargin{:});
      else
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(582, this, varargin{:});
      else
    ...
    function varargout = push_back(this, varargin)
      ...
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.SymbolicBayesTree')
        gtsam_wrapper(586, this, varargin{:});
      else
