...
classdef GaussianBayesNet < handle
  ...
  methods
    function obj = GaussianBayesNet(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(954, varargin{2});
        end
        gtsam_wrapper(953, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(955);
      elseif nargin == 1 && isa(varargin{1},'gtsam.GaussianConditional')
        my_ptr = gtsam_wrapper(956, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(957, obj.ptr_gtsamGaussianBayesNet);
    end
    ...
    function varargout = optimizeGradientSearch(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(973, this, varargin{:});
    end
    ...
    function varargout = push_back(this, varargin)
      ...
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.GaussianBayesNet')
        gtsam_wrapper(976, this, varargin{:});
      else
