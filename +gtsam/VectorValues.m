...
classdef VectorValues < handle
  ...
  methods
    function obj = VectorValues(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(741, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(742);
      elseif nargin == 1 && isa(varargin{1},'gtsam.VectorValues')
        my_ptr = gtsam_wrapper(743, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(744, obj.ptr_gtsamVectorValues);
    end
    ...
    function varargout = insert(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'double') && size(varargin{2},2)==1
        gtsam_wrapper(753, this, varargin{:});
      else
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(755, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Zero(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.VectorValues')
        varargout{1} = gtsam_wrapper(765, varargin{:});
      else
