...
classdef GaussNewtonParams < gtsam.NonlinearOptimizerParams
  ...
  methods
    function obj = GaussNewtonParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1272, varargin{2});
        end
        base_ptr = gtsam_wrapper(1271, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1273);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1274, obj.ptr_gtsamGaussNewtonParams);
    end
