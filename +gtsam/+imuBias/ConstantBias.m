...
classdef ConstantBias < handle
  ...
  methods
    function obj = ConstantBias(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2189, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2190);
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(2191, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2192, obj.ptr_gtsamimuBiasConstantBias);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2202, this, varargin{:});
      else
    ...
    function varargout = vector(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2204, this, varargin{:});
    end
  ...
  methods(Static = true)
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2207, varargin{:});
    end
