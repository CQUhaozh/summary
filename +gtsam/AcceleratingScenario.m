...
classdef AcceleratingScenario < gtsam.Scenario
  ...
  methods
    function obj = AcceleratingScenario(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2399, varargin{2});
        end
        base_ptr = gtsam_wrapper(2398, my_ptr);
      elseif nargin == 5 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'gtsam.Point3') && isa(varargin{3},'double') && isa(varargin{4},'double') && isa(varargin{5},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2400, varargin{1}, varargin{2}, varargin{3}, varargin{4}, varargin{5});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2401, obj.ptr_gtsamAcceleratingScenario);
    end
