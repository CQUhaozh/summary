...
classdef Values < handle
  ...
  methods
    function obj = Values(varargin)
      ...
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1151);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Values')
        my_ptr = gtsam_wrapper(1152, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1153, obj.ptr_gtsamValues);
    end
    ...
    function varargout = size(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1194, this, varargin{:});
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1212, varargin{:});
      else
