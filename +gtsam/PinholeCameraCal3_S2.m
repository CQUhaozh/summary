...
classdef PinholeCameraCal3_S2 < handle
  ...
  methods
    function obj = PinholeCameraCal3_S2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2414, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2415);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(2416, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3_S2')
        my_ptr = gtsam_wrapper(2417, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2418, obj.ptr_gtsamPinholeCameraCal3_S2);
    end
    ...
    function varargout = localCoordinates(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.PinholeCameraCal3_S2')
        varargout{1} = gtsam_wrapper(2423, this, varargin{:});
      else
    ...
    function varargout = project(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(2426, this, varargin{:});
      else
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(2427, this, varargin{:});
      else
    ...
    function varargout = range(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(2428, this, varargin{:});
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      % DIM usage: Dim() : returns size_t
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(2432, varargin{:});
    end
    ...
    function varargout = Project(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(2436, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.PinholeCameraCal3_S2.Project');
      end
    end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2437, varargin{:});
      else
