...
classdef LabeledSymbol < handle
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(1073, obj.ptr_gtsamLabeledSymbol);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1081, this, varargin{:});
      else
