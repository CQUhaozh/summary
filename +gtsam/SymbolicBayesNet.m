  ...
  methods
    function obj = SymbolicBayesNet(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(608, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(609);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesNet')
        my_ptr = gtsam_wrapper(610, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(611, obj.ptr_gtsamSymbolicBayesNet);
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.SymbolicBayesNet') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(614, this, varargin{:});
      else
    ...
    function varargout = front(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(615, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(616, this, varargin{:});
      else
    ...
    function varargout = push_back(this, varargin)
      ...
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.SymbolicBayesNet')
        gtsam_wrapper(618, this, varargin{:});
      else
    ...
    function varargout = saveGraph(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(619, this, varargin{:});
      else
