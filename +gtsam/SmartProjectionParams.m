  ...
  methods
    function obj = SmartProjectionParams(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2164, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2165);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2166, obj.ptr_gtsamSmartProjectionParams);
    end
