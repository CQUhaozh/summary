  ...
  methods
    function obj = VariableIndex(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(635, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(636);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicFactorGraph')
        my_ptr = gtsam_wrapper(637, varargin{1});
      ...
      elseif nargin == 1 && isa(varargin{1},'gtsam.VariableIndex')
        my_ptr = gtsam_wrapper(640, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(641, obj.ptr_gtsamVariableIndex);
    end
