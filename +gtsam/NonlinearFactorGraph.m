  ...
  methods
    function obj = NonlinearFactorGraph(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1094, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1095);
      elseif nargin == 1 && isa(varargin{1},'gtsam.NonlinearFactorGraph')
        my_ptr = gtsam_wrapper(1096, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1097, obj.ptr_gtsamNonlinearFactorGraph);
    end
    ...
    function varargout = at(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1099, this, varargin{:});
    end
    ...
    function varargout = push_back(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.NonlinearFactorGraph')
        gtsam_wrapper(1112, this, varargin{:});
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.NonlinearFactor')
        gtsam_wrapper(1113, this, varargin{:});
      else
    ...
    function varargout = resize(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1116, this, varargin{:});
    end
