...
classdef SimpleCamera < handle
  ...
  methods
    function obj = SimpleCamera(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(502, varargin{2});
        end
        gtsam_wrapper(501, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(503);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(504, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3_S2')
        my_ptr = gtsam_wrapper(505, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(506, obj.ptr_gtsamSimpleCamera);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(513, this, varargin{:});
      else
    ...
    function varargout = project(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(514, this, varargin{:});
      else
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(515, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = Project(varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Point3')
        varargout{1} = gtsam_wrapper(525, varargin{:});
      else
        error('Arguments do not match any overload of function gtsam.SimpleCamera.Project');
      end
    end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(526, varargin{:});
      else
