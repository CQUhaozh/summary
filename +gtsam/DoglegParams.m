...
classdef DoglegParams < gtsam.NonlinearOptimizerParams
  ...
  methods
    function obj = DoglegParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1326, varargin{2});
        end
        base_ptr = gtsam_wrapper(1325, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(1327);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1328, obj.ptr_gtsamDoglegParams);
    end
    ...
    function varargout = setVerbosityDL(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1351, this, varargin{:});
      else
