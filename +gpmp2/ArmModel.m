...
classdef ArmModel < handle
  ...
  methods
    ...
    function delete(obj)
      gpmp2_wrapper(114, obj.ptr_gpmp2ArmModel);
    end
    ...
    function varargout = dof(this, varargin)
      ...
      varargout{1} = gpmp2_wrapper(115, this, varargin{:});
    end
    ...
    function varargout = nr_body_spheres(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gpmp2_wrapper(117, this, varargin{:});
    end
