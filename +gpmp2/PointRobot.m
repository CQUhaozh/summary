  ...
  methods
    function obj = PointRobot(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gpmp2_wrapper(97, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric')
        my_ptr = gpmp2_wrapper(98, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gpmp2_wrapper(99, obj.ptr_gpmp2PointRobot);
    end
    ...
    function varargout = dof(this, varargin)
      ...
      varargout{1} = gpmp2_wrapper(100, this, varargin{:});
    end
    ...
    function varargout = forwardKinematicsPose(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gpmp2_wrapper(101, this, varargin{:});
      else
    ...
    function varargout = forwardKinematicsPosition(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gpmp2_wrapper(102, this, varargin{:});
      else
