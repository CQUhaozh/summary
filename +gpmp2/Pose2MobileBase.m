  ...
  methods
    function obj = Pose2MobileBase(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gpmp2_wrapper(37, my_ptr);
      elseif nargin == 0
        my_ptr = gpmp2_wrapper(38);
      else
    ...
    function delete(obj)
      gpmp2_wrapper(39, obj.ptr_gpmp2Pose2MobileBase);
    end
    ...
    function varargout = dof(this, varargin)
      ...
      varargout{1} = gpmp2_wrapper(40, this, varargin{:});
    end
    ...
    function varargout = forwardKinematicsPose(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Pose2')
        varargout{1} = gpmp2_wrapper(41, this, varargin{:});
      else
    ...
    function varargout = forwardKinematicsPosition(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Pose2')
        varargout{1} = gpmp2_wrapper(42, this, varargin{:});
      else
