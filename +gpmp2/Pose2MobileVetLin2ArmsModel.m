...
classdef Pose2MobileVetLin2ArmsModel < handle
  ...
  methods
    ...
    function delete(obj)
      gpmp2_wrapper(154, obj.ptr_gpmp2Pose2MobileVetLin2ArmsModel);
    end
