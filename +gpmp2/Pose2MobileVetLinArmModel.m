...
classdef Pose2MobileVetLinArmModel < handle
  ...
  methods
    ...
    function delete(obj)
      gpmp2_wrapper(146, obj.ptr_gpmp2Pose2MobileVetLinArmModel);
    end
