  ...
  methods
    function obj = TrajOptimizerSetting(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gpmp2_wrapper(317, my_ptr);
      elseif nargin == 1 && isa(varargin{1},'numeric')
        my_ptr = gpmp2_wrapper(318, varargin{1});
      else
    ...
    function delete(obj)
      gpmp2_wrapper(319, obj.ptr_gpmp2TrajOptimizerSetting);
    end
    ...
    function varargout = set_Qc_model(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        gpmp2_wrapper(326, this, varargin{:});
      else
